...
const menuGroups = ref([
  {
    menuItems: [
      { icon: LayoutDashboard, label: 'Dashboard', route: '/dashboardadmin/dashboard' },
      { icon: Gem, label: 'Usuarios', route: '/dashboardadmin/user' },
      { icon: Wallet, label: 'Contratos', route: '/dashboardadmin/contratos' },
      { icon: Network, label: 'Sistema', route: '/network' },
