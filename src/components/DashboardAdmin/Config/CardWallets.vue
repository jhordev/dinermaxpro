...
<template>
  <section class="rounded-[15px] bg-colorInputClaro p-2.5 shadow-default dark:bg-bgDashboardDark w-full">
    <div class="flex relative flex-row-reverse gap-2 md:gap-2.5 items-center pt-5 md:pt-0">
      ...
      <div class="w-[80px] md:w-[150px] h-[80px] md:h-[150px] absolute top-0 right-0 md:relative flex items-center justify-center border rounded-lg overflow-hidden bg-gray-50 dark:bg-gray-700">
        <img
            v-if="qrImage"
            :src="qrImage"
            alt="QR Code"
