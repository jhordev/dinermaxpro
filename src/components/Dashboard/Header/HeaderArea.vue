...
<template>
  ...
  >
    <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
      <h1 class="font-bold text-[24px] text-colorTextBlack dark:text-white tracking-[2.4px]">Dashboard</h1>
      <div class="flex items-center gap-1 md:gap-2 sm:gap-4 lg:hidden">
